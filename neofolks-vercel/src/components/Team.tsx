...
export default function Team() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#000000", position: "relative" }}>
      ...
      <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: "300px", background: "linear-gradient(to bottom, rgba(59,30,86,0.6), transparent)", pointerEvents: "none", zIndex: 0 }} />
      {/* Page Header */}
      <section style={{ paddingTop: "70px", paddingBottom: "30px", position: "relative", overflow: "hidden" }}>
      ...
      {/* Team Showcase */}
      <section style={{ padding: "20px 48px 60px", boxSizing: "border-box", marginTop: "-20px" }}>
        <div style={{ maxWidth: "960px", margin: "0 auto", display: "flex", flexDirection: "row", alignItems: "flex-start", gap: "48px", paddingLeft: "80px" }}>

          {/* ── Photo Grid ── */}
          <div style={{ display: "flex", gap: "12px", flexShrink: 0, alignItems: "flex-start" }}>

            {/* Column 1 — offset down so cards flank the director */}
            <div style={{ display: "flex", flexDirection: "column", gap: "12px", marginTop: "97px" }}>
              {col1.map((m) => (
          ...
          {/* ── Name List ── */}
          <div style={{ display: "flex", flexDirection: "column", gap: "20px", paddingTop: "8px", flex: 1, marginTop: "97px" }}>
            {members.map((m) => (
